            ...
            <div class="col-11 col-sm-9 col-md-8 rounded-5 py-2"
                ...
                <div class="row justify-content-end">
                    <div class="col-12 col-sm-10 col-md-8">
                        <h4 class="text-center text-black text-decoration-underline fw-bold mb-3">Setores</h4>
                    </div>
                    <div class="col-12 col-sm-2 d-inline-flex justify-content-end">
                        <a href="CadastroSetor.html" class="text-decoration-none text-black mx-2"
                            style="font-size: larger;" title="Cadastrar Setor">
                            <i class="mdi mdi-domain-plus"></i>
                        </a>
                        <a href="HomeAvaliacao.html" class="text-decoration-none text-black mx-2"
                            ...
                            <table class="table table-striped table-hover align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><%= setor.getNome() %></td>
                                        <td>
                                            <%= setor.getData_cadastro() != null ? sdf.format(new Date(setor.getData_cadastro().getTime())) : "" %>
                                        </td>
                                        <td>
                                            <%= setor.getData_atualizacao() != null ? sdf.format(new Date(setor.getData_atualizacao().getTime())) : "" %>
                                        </td>
                                        <td>
                                            <form method="post" action="SetorController?acao=4" style="display:inline;">
                                                <input type="hidden" name="id_setor" value="<%= setor.getId() %>">
